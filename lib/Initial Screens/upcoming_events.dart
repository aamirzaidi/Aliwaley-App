                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => AddEventInfo(),
                          ));
                    },
                    child: Container(
                      padding: EdgeInsets.only(
                          top: 4.0, right: 10.0, left: 10.0, bottom: 4.0),
                      child: Text(
                        'Add Your Event',
                        style: TextStyle(
                            fontFamily: 'Sniglet',
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final time = events[index - 1].get("time");
                    final date = events[index - 1].get('date');
                    final location = events[index - 1].get('location');
                    final eventName = events[index - 1].get('event_name');
                    final locationLink =
                        events[index - 1].get('locationLink') ?? 'Offline';
                    final imageUrl = events[index - 1].get('imageUrl');
                ...
                children: <Widget>[
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          RaisedButton(
                            ...
                            child: Text(
                              locationLink == 'Offline'
                                  ? 'Offline'
                                  : 'Go To Link',
                              style: TextStyle(
                                  color: locationLink == 'Offline'
                                      ? Colors.black
                                      : Colors.deepOrange),
                            ),
                            onPressed: () async {
                  ...
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Image(
                        image: imageUrl == null
                            ? AssetImage('assets/zulfikar.png')
